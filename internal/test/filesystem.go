...
func (mock FileSystem) fakeZeroOpen(name string) (io.ReadCloser, error) {
	var (
		r0 io.ReadCloser
		r1 error
	)
...
func (mock FileSystem) fakeZeroOpenFile(name string, flag int, perm os.FileMode) (io.WriteCloser, error) {
	var (
		r0 io.WriteCloser
		r1 error
	)
