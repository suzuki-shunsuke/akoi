...
type (
	...
	FileSystem struct {
		...
		impl                   struct {
			...
			ReadLink     func(p0 string) (string, error)
			RemoveAll    func(p0 string) error
			RemoveFile   func(p0 string) error
			RemoveLink   func(p0 string) error
...
func (mock FileSystem) fakeZeroChmod(name string, mode os.FileMode) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) fakeZeroCopy(dst io.Writer, src io.Reader) (int64, error) {
	var (
		r0 int64
		r1 error
	)
...
func (mock FileSystem) fakeZeroExistFile(p0 string) bool {
	var (
		r0 bool
	)
	return r0
...
func (mock FileSystem) fakeZeroExpandEnv(p0 string) string {
	var (
		r0 string
	)
	return r0
...
func (mock FileSystem) fakeZeroGetFileLstat(p0 string) (os.FileInfo, error) {
	var (
		r0 os.FileInfo
		r1 error
	)
...
func (mock FileSystem) fakeZeroMkdirAll(p0 string) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) fakeZeroMkLink(src, dst string) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) Open(name string) (*os.File, error) {
...
func (mock *FileSystem) SetFuncOpen(impl func(name string) (*os.File, error)) *FileSystem {
	mock.impl.Open = impl
	return mock
}

// SetReturnOpen sets a fake method.
func (mock *FileSystem) SetReturnOpen(r0 *os.File, r1 error) *FileSystem {
	mock.impl.Open = func(string) (*os.File, error) {
		return r0, r1
	}
	return mock
}
...
func (mock FileSystem) fakeZeroOpen(name string) (*os.File, error) {
	var (
		r0 *os.File
		r1 error
	)
...
func (mock FileSystem) OpenFile(name string, flag int, perm os.FileMode) (*os.File, error) {
...
func (mock *FileSystem) SetFuncOpenFile(impl func(name string, flag int, perm os.FileMode) (*os.File, error)) *FileSystem {
	mock.impl.OpenFile = impl
	return mock
}

// SetReturnOpenFile sets a fake method.
func (mock *FileSystem) SetReturnOpenFile(r0 *os.File, r1 error) *FileSystem {
	mock.impl.OpenFile = func(string, int, os.FileMode) (*os.File, error) {
		return r0, r1
	}
	return mock
}
...
func (mock FileSystem) fakeZeroOpenFile(name string, flag int, perm os.FileMode) (*os.File, error) {
	var (
		r0 *os.File
		r1 error
	)
...
func (mock FileSystem) fakeZeroReadLink(p0 string) (string, error) {
	var (
		r0 string
		r1 error
	)
...
func (mock FileSystem) fakeZeroRemoveAll(p0 string) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) fakeZeroRemoveFile(p0 string) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) fakeZeroRemoveLink(p0 string) error {
	var (
		r0 error
	)
	return r0
...
func (mock FileSystem) fakeZeroTempDir() (string, error) {
	var (
		r0 string
		r1 error
	)
...
func (mock FileSystem) fakeZeroWriteFile(dest string, data []byte) error {
	var (
		r0 error
	)
	return r0
