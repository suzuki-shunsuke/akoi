...
type (
	...
	ConfigReader struct {
		...
		impl                   struct {
			Read func(p0 string) (r0 test.Config, r1 error)
		}
	}
)
...
func (mock ConfigReader) Read(p0 string) (r0 test.Config, r1 error) {
...
func (mock *ConfigReader) SetFuncRead(impl func(p0 string) (r0 test.Config, r1 error)) *ConfigReader {
	mock.impl.Read = impl
	return mock
}
...
func (mock ConfigReader) fakeZeroRead(p0 string) (r0 test.Config, r1 error) {
	return r0, r1
}
