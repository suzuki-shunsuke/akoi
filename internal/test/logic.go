...
type (
	...
	Logic struct {
		...
		impl                   struct {
			...
			CreateLink              func(file test.File) (r0 test.File, r1 error)
			RecreateLink            func(file test.File) (r0 test.File, r1 error)
			RemoveFileAndCreateLink func(file test.File) (r0 test.File, r1 error)
			SetupConfig             func(cfg test.Config) (r0 test.Config, r1 error)
			SetupPkgConfig          func(cfg test.Config, name string, pkg test.Package, numCPUs int) (r0 test.Package, r1 error)
			SetupFileConfig         func(pkg test.Package, file test.File) (r0 test.File, r1 error)
		}
	}
)
...
func (mock Logic) InstallPackage(ctx context.Context, pkg test.Package, params test.InstallParams) (r0 test.Package, r1 error) {
...
func (mock *Logic) SetFuncInstallPackage(impl func(ctx context.Context, pkg test.Package, params test.InstallParams) (r0 test.Package, r1 error)) *Logic {
...
func (mock Logic) fakeZeroInstallPackage(ctx context.Context, pkg test.Package, params test.InstallParams) (r0 test.Package, r1 error) {
	return r0, r1
}

// InstallFile is a mock method.
func (mock Logic) InstallFile(file *test.File, pkg test.Package, params test.InstallParams, tmpDir string, body io.Reader) (r0 error) {
...
func (mock *Logic) SetFuncInstallFile(impl func(file *test.File, pkg test.Package, params test.InstallParams, tmpDir string, body io.Reader) (r0 error)) *Logic {
...
func (mock Logic) fakeZeroInstallFile(file *test.File, pkg test.Package, params test.InstallParams, tmpDir string, body io.Reader) (r0 error) {
	return r0
}

// GetInstalledFiles is a mock method.
func (mock Logic) GetInstalledFiles(files []test.File) (r0 []test.File) {
...
func (mock *Logic) SetFuncGetInstalledFiles(impl func(files []test.File) (r0 []test.File)) *Logic {
...
func (mock Logic) fakeZeroGetInstalledFiles(files []test.File) (r0 []test.File) {
	return r0
}

// CreateLink is a mock method.
func (mock Logic) CreateLink(file test.File) (r0 test.File, r1 error) {
...
func (mock *Logic) SetFuncCreateLink(impl func(file test.File) (r0 test.File, r1 error)) *Logic {
...
func (mock Logic) fakeZeroCreateLink(file test.File) (r0 test.File, r1 error) {
	return r0, r1
}

// RecreateLink is a mock method.
func (mock Logic) RecreateLink(file test.File) (r0 test.File, r1 error) {
...
func (mock *Logic) SetFuncRecreateLink(impl func(file test.File) (r0 test.File, r1 error)) *Logic {
...
func (mock Logic) fakeZeroRecreateLink(file test.File) (r0 test.File, r1 error) {
	return r0, r1
}

// RemoveFileAndCreateLink is a mock method.
func (mock Logic) RemoveFileAndCreateLink(file test.File) (r0 test.File, r1 error) {
...
func (mock *Logic) SetFuncRemoveFileAndCreateLink(impl func(file test.File) (r0 test.File, r1 error)) *Logic {
...
func (mock Logic) fakeZeroRemoveFileAndCreateLink(file test.File) (r0 test.File, r1 error) {
	return r0, r1
}

// SetupConfig is a mock method.
func (mock Logic) SetupConfig(cfg test.Config) (r0 test.Config, r1 error) {
	methodName := "SetupConfig" // nolint: goconst
	if mock.impl.SetupConfig != nil {
		return mock.impl.SetupConfig(cfg)
	}
	if mock.callbackNotImplemented != nil {
		mock.callbackNotImplemented(mock.t, mock.name, methodName)
	} else {
	...
	return mock.fakeZeroSetupConfig(cfg)
}

// SetFuncSetupConfig sets a method and returns the mock.
func (mock *Logic) SetFuncSetupConfig(impl func(cfg test.Config) (r0 test.Config, r1 error)) *Logic {
...
func (mock *Logic) SetReturnSetupConfig(r0 test.Config, r1 error) *Logic {
	mock.impl.SetupConfig = func(test.Config) (test.Config, error) {
		return r0, r1
	}
	return mock
}
...
func (mock Logic) fakeZeroSetupConfig(cfg test.Config) (r0 test.Config, r1 error) {
	return r0, r1
}

// SetupPkgConfig is a mock method.
func (mock Logic) SetupPkgConfig(cfg test.Config, name string, pkg test.Package, numCPUs int) (r0 test.Package, r1 error) {
...
func (mock *Logic) SetFuncSetupPkgConfig(impl func(cfg test.Config, name string, pkg test.Package, numCPUs int) (r0 test.Package, r1 error)) *Logic {
...
func (mock Logic) fakeZeroSetupPkgConfig(cfg test.Config, name string, pkg test.Package, numCPUs int) (r0 test.Package, r1 error) {
	return r0, r1
}

// SetupFileConfig is a mock method.
func (mock Logic) SetupFileConfig(pkg test.Package, file test.File) (r0 test.File, r1 error) {
...
func (mock *Logic) SetFuncSetupFileConfig(impl func(pkg test.Package, file test.File) (r0 test.File, r1 error)) *Logic {
...
func (mock Logic) fakeZeroSetupFileConfig(pkg test.Package, file test.File) (r0 test.File, r1 error) {
	return r0, r1
}
