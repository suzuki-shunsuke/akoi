...
type (
	...
	Archiver struct {
		...
		impl                   struct {
			Read func(input io.Reader, destination string) (r0 error)
		}
	}
)
...
func (mock Archiver) Read(input io.Reader, destination string) (r0 error) {
...
func (mock *Archiver) SetFuncRead(impl func(input io.Reader, destination string) (r0 error)) *Archiver {
	mock.impl.Read = impl
	return mock
}
...
func (mock Archiver) fakeZeroRead(input io.Reader, destination string) (r0 error) {
	return r0
}
